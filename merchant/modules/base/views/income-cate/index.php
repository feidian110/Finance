...
$this->title = Yii::t('app','Income Category');
    ...
    <div class="col-sm-12">
        <div class="nav-tabs-custom">
            <ul class="nav nav-tabs">
                ...
                <li class="active"><a href="<?= Url::to(['income-cate/index']);?>"> 收入类别</a></li>
                <li><a href="<?= Url::to(['expend-cate/index']);?>"> 支出类别</a></li>
                <li><a href="<?= Url::to(['settlement-method/index']);?>"> 结算方式</a></li>
